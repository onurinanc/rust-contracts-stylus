...
In order to make an xref:erc6909.adoc[ERC-6909] token with https://docs.rs/openzeppelin-stylus/0.3.0/openzeppelin_stylus/token/erc6909/extensions/supply/index.html[Supply] flavour,
